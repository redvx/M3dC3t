...
public class DamageUtill
    ...
    public static float getDamageInPercent(ItemStack stack) {
        return (float) DamageUtill.getItemDamage(stack) / (float) stack.getMaxDamage() * 100.0f;
    }
    ...
    public static float calculateDamage(double posX, double posY, double posZ, Entity entity) {
        ...
        if (entity instanceof EntityLivingBase) {
            finald = DamageUtill.getBlastReduction((EntityLivingBase) entity, DamageUtill.getDamageMultiplied(damage), new Explosion(DamageUtill.mc.world, null, posX, posY, posZ, 6.0f, false, true));
        }
        return (float) finald;
    }
    ...
    public static float calculateDamage(Entity crystal, Entity entity) {
        return DamageUtill.calculateDamage(crystal.posX, crystal.posY, crystal.posZ, entity);
    }

    public static float calculateDamage(BlockPos pos, Entity entity) {
        return DamageUtill.calculateDamage((double) pos.getX() + 0.5, pos.getY() + 1, (double) pos.getZ() + 0.5, entity);
    }
