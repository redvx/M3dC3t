...
class RenderUtil
    ...
    void drawWaypointImage (BlockPos pos , GLUProjection.Projection projection , Color color , String name , boolean rectangle , Color rectangleColor ) {
        ...
        float textWidth = M3dC3t.textManager.getStringWidth ( text );
        M3dC3t.textManager.drawString ( text , - ( textWidth / 2.0f ) , - ( (float) M3dC3t.textManager.getFontHeight ( ) / 2.0f ) + (float) M3dC3t.textManager.getFontHeight ( ) / 2.0f , color.getRGB ( ) , false );
        GlStateManager.translate ( - projection.getX ( ) , - projection.getY ( ) , 0.0 );
    ...
    void drawSexyBoxPhobosIsRetardedFuckYouESP ( AxisAlignedBB a , Color boxColor , Color outlineColor , float lineWidth , boolean outline , boolean box , float alpha , float scale , float slab ) {
    ...
    void drawText ( AxisAlignedBB pos , String text ) {
        ...
        GlStateManager.disableDepth ( );
        GlStateManager.translate ( - ( (double) M3dC3t.textManager.getStringWidth ( text ) / 2.0 ) , 0.0 , 0.0 );
    ...
    void drawProjectedText ( GLUProjection.Projection projection , float addX , float addY , String text , Color color , boolean shadow ) {
        if ( projection.getType ( ) == GLUProjection.Projection.Type.INSIDE ) {
            GlStateManager.pushMatrix ( );
            GlStateManager.translate ( projection.getX ( ) , projection.getY ( ) , 0.0 );
            M3dC3t.textManager.drawString ( text , - ( (float) M3dC3t.textManager.getStringWidth ( text ) / 2.0f ) + addX , addY , color.getRGB ( ) , shadow );
            GlStateManager.translate ( - projection.getX ( ) , - projection.getY ( ) , 0.0 );
            GlStateManager.popMatrix ( );
        }
    }
