...
public class MathUtil
    ...
    public static Vec3d getInterpolatedRenderPos(Entity entity, float ticks) {
        return MathUtil.interpolateEntity(entity, ticks).subtract(Minecraft.getMinecraft().getRenderManager().viewerPosX, Minecraft.getMinecraft().getRenderManager().viewerPosY, Minecraft.getMinecraft().getRenderManager().viewerPosZ);
    }
}