...
public class Replenish extends Module {
    ...
    private final Setting<Integer> gapStack = register(new Setting<Integer>("GapStack", 50, 50, 64));
    private final Setting<Integer> xpStackAt = register(new Setting<Integer>("XPStack", 50, 50, 64));
